...
class TidalAPI {
    ...
    getStreamUrl(trackId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._baseRequest('/tracks/' + encodeURIComponent(trackId) + '/playbackinfopostpaywall', {
     ...
     * @param query
     */
    getPlaylists(userId, query = null) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._baseRequest('/users/' + encodeURIComponent(userId) + "/playlists", query);
        });
    }
    getETag(playlistId) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    createPlaylist(title, description, userId) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    createPlaylistIfNotExists(title, description, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const exists = yield this.checkIfPlaylistExists(title);
            if (exists)
                return exists;
            return (yield this.createPlaylist(title, description, userId));
        });
    }
    /**
     * Get track stream URL.
    ...
    _baseRequestRaw(url, params = null, method, additionalHeaders, paramsAsUrlEncoded, emptyResponse = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            if (body === null) {
                result = yield (0, node_fetch_1.default)(baseURL + url, {
                    method,
                    headers
                });
            }
